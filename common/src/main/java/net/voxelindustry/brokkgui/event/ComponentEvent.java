...
public class ComponentEvent extends HermodEvent
{
    ...
    public static final EventType<Added>          ADDED   = new EventType<>(ANY, "COMPONENT_ADDED_EVENT");
    public static final EventType<Removed>        REMOVED = new EventType<>(ANY, "COMPONENT_REMOVED_EVENT_");
