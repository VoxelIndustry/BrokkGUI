...
public class PaintStyle extends Paint
{
    ...
    {
        return this.style().getStyleValue("background-texture", Texture.class, Texture.EMPTY);
    }
    ...
    {
        return this.style().getStyleValue("background-color", Color.class, Color.ALPHA);
    }
    ...
    {
        return this.style().getStyleValue("foreground-texture", Texture.class, Texture.EMPTY);
    }
    ...
    {
        return this.style().getStyleValue("foreground-color", Color.class, Color.ALPHA);
    }
    ...
    {
        return this.style().getStyleValue("border-" + side.getCssString() + "-width", Float.class, 0f);
    }
    ...
    {
        return this.style().getStyleValue("border-" + corner.getCssString() + "-radius", Integer.class, 0);
    }
    ...
    {
        return this.style().getStyleValue("border-color", Color.class, Color.ALPHA);
    }
    ...
    {
        return this.style().getStyleValue("border-image-source", Texture.class, Texture.EMPTY);
    }
    ...
    {
        return this.style().getStyleValue("border-image-slice", RectBox.class, RectBox.ONE);
    }
    ...
    {
        return this.style().getStyleValue("border-image-width", RectBox.class, RectBox.ONE);
    }
    ...
    {
        return this.style().getStyleValue("border-image-outset", RectBox.class, RectBox.EMPTY);
    }
