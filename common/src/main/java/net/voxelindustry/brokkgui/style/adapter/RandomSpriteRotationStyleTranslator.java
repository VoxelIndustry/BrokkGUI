...
public class RandomSpriteRotationStyleTranslator implements IStyleDecoder<RandomSpriteRotation>, IStyleEncoder<RandomSpriteRotation>, IStyleValidator<RandomSpriteRotation>
{
    @Override
